...
{
    /// <summary>
    /// Execution class of Nutaku core API
    /// </summary>
    static class CoreApi
    {
            ...
            UnityWebRequestUtil.callbackFunctionDelegate callbackFunctionDelegate)
        {
            ...
            PostCommand<ConfigGetResult>(
               "Config.Get",
               new Dictionary<string, object>() { { "versionCode", SdkPlugin.settings.versionCode } },
               consumerKey,
               consumerSecret,
               myMonoBehaviour,
            ...
            UnityWebRequestUtil.callbackFunctionDelegate callbackFunctionDelegate)
        {
            try
            {
                ...
                builder.Query = QueryParameterBuilder.ToQueryString(queryParams);
                var uri = builder.Uri;
